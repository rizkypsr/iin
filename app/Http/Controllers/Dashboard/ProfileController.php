...
class ProfileController extends Controller
{
    ...
    public function update(Request $request): RedirectResponse
    {
        $request->validate([
            ...
            'iin_nasional_profile.aspi_recommendation_letter' => 'required|string|max:255',
            ...
            'iin_nasional_profile.remarks_status' => 'required|string|max:255',
            ...
            'single_iin_profile.remarks_status' => 'required|string|max:255',
