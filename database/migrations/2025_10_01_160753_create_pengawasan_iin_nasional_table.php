...
return new class extends Migration
{
    ...
    {
        Schema::create('pengawasan_iin_nasional', function (Blueprint $table) {
            $table->id();
            $table->string('application_number')->unique();
            $table->foreignId('user_id')->constrained()->onDelete('cascade');
            $table->foreignId('iin_nasional_profile_id')->constrained()->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('pengawasan_iin_nasional');
    }
};
