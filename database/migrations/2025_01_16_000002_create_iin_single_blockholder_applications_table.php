...
return new class extends Migration
{
    ...
    {
        Schema::create('iin_single_blockholder_applications', function (Blueprint $table) {
            $table->id();
            ...
            $table->json('iin_block_range')->nullable(); // Store block range information
    ...
    {
        Schema::dropIfExists('iin_single_blockholder_applications');
    }
};
