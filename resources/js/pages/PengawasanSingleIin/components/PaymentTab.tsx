...
import { PengawasanSingleIinApplication, PaymentDocument } from "@/types";
...
export default function PaymentTab({ application }: { application: PengawasanSingleIinApplication }) {
                                            ...
                                            {application.payment_documents.map((document: PaymentDocument, index: number) => (
                                                ...
                                                >
                                                    ...
                                                    <Button
                                                        ...
                                                        onClick={() =>
                                                            window.open(
                                                                route('pengawasan-single-iin.download-payment-document', [
                                                                    application.id,
                                                                    index,
                                                                ]),
                                                                '_blank',
                                ...
                                {application.payment_proof_documents && application.payment_proof_documents.length > 0 ? (
                                    ...
                                    <div className="flex justify-between items-center">
                                        ...
                                        <Button
                                            ...
                                            onClick={() =>
                                                window.open(
                                                    route('pengawasan-single-iin.download-file', [application.id, 'payment_proof']),
                                                    '_blank',
                                                )
                                            }
                                        >
