...
import { PengawasanSingleIinApplication, PaymentDocument, IinNasionalApplication } from "@/types";
...
export default function DocumentTab({ application }: { application: PengawasanSingleIinApplication }) {
    const [selectedApplication, setSelectedApplication] = useState<PengawasanSingleIinApplication>(application);
                    ...
                    {application.status === 'terbit' && (
                        <div className="flex justify-between items-center p-3 bg-green-50 rounded-lg border border-green-200">
                            <div className="flex gap-3 items-center">
                                ...
                                <div>
                                    <p className="font-medium text-gray-800">Dokumen Pemantauan</p>
