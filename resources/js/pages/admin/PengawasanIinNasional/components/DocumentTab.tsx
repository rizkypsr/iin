...
import { PaymentDocument, PengawasanIinNasionalApplication } from "@/types";
import { format } from "date-fns";
import { id } from "date-fns/locale";
import { Award, CreditCard, Download, FileText, Shield } from "lucide-react";
import { useState } from "react";

export default function DocumentTab({ application }: { application: PengawasanIinNasionalApplication }) {
    ...
    const downloadFile = (type: string, index?: number) => {
        window.open(
            route('pengawasan-iin-nasional.download-file', {
