...
export default function DetailTab({ application }: { application: PengawasanSingleIinApplication }) {
    return (
        <>
            ...
            {application.single_iin_profile && (
                <Card>
                    <CardHeader>
                    ...
                    <CardContent className="space-y-4">
                        <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                            {application.single_iin_profile.institution_name && (
                                <div>
                            ...
                            {application.single_iin_profile.institution_type && (
                                <div>
                                    <Label className="text-sm font-medium text-gray-500">Brand</Label>
                                    <p className="text-sm">{application.single_iin_profile.institution_type}</p>
                                </div>
                            )}
                            {application.single_iin_profile.year && (
                                <div>
                            ...
                            {application.single_iin_profile.regional && (
                                <div>
                            ...
                            {application.single_iin_profile.usage_purpose && (
                                <div>
                            ...
                            {application.single_iin_profile.address && (
                                <div className="md:col-span-2">
                                    <Label className="text-sm font-medium text-gray-500">Alamat</Label>
                                    <p className="text-sm">{application.single_iin_profile.address}</p>
                                </div>
                            )}
                            {application.single_iin_profile.phone_fax && (
                                <div>
                            ...
                            {application.single_iin_profile.email && (
                                <div>
                            ...
                            {application.single_iin_profile.contact_person && (
                                <div>
                            ...
                            {application.single_iin_profile.remarks_status && (
                                <div className="md:col-span-2">
