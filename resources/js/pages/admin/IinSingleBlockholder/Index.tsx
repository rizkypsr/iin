...
import { IinSingleBlockholderApplication, PageProps } from '@/types';
...
export default function Index({ auth, applications, application_counts }: Props) {
    return (
        <DashboardLayout user={auth.user} title="Admin - IIN Single Blockholder" applicationCounts={application_counts}>
            ...
            <div className="mb-8">
                <h2 className="text-xl font-semibold leading-tight text-gray-800">Manajemen Aplikasi IIN Single Blockholder</h2>
            </div>
