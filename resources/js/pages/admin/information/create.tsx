...
export default function InformationCreate({ application_counts }: Props) {
    ...
    return (
        <DashboardLayout title="Tambah Informasi" applicationCounts={application_counts}>
            ...
            <div className="space-y-6">
                ...
                <div className="flex items-center space-x-3">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold text-gray-900">Tambah Informasi</h1>
                        <p className="text-gray-600">Buat informasi baru untuk halaman Layanan Publik</p>
                    </div>
                </div>
                ...
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>Isi detail informasi yang akan ditampilkan</CardDescription>
                    </CardHeader>
                    <CardContent>
