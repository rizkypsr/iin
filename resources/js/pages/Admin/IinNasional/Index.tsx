...
export default function Index({ auth, applications }: Props) {
    return (
        <DashboardLayout
            user={auth.user}
            title="Admin - IIN Nasional"
        >
            <Head title="Admin - IIN Nasional" />

            <div className="mb-8">
                <h2 className="font-semibold text-xl text-gray-800 leading-tight">
                    Manajemen Aplikasi IIN Nasional
                </h2>
            </div>
                            ...
                            {applications.data.length === 0 ? (
                                <div className="text-center py-8">
                                    ...
                                    <p className="text-gray-400 text-sm mt-2">
                                        Tidak ada aplikasi IIN Nasional yang tersedia untuk ditinjau.
                                    </p>
                                </div>
                            ) : (
                                                    ...
                                                    <TableCell>
                                                        <div className="flex items-center gap-2">
                                                            <Button
                                                                ...
                                                                asChild
                                                            >
                                                                <Link href={route('admin.iin-nasional.show', application.id)}>
