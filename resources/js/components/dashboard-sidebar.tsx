...
const menuItems = {
    user: [
        ...
        { name: 'Pemantauan IIN Nasional', href: '/pengawasan-iin-nasional', icon: Shield },
        { name: 'Pemantauan Single IIN', href: '/pengawasan-single-iin', icon: Shield },
    ...
    admin: [
        ...
        { name: 'Pemantauan IIN Nasional', href: '/admin/pengawasan-iin-nasional', icon: Shield },
