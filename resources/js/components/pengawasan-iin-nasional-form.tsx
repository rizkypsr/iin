...
interface PengawasanIinNasionalData {
    company_name?: string;
...
interface PengawasanIinNasionalFormProps {
    data: PengawasanIinNasionalData;
    setData: (key: keyof PengawasanIinNasionalData, value: any) => void;
    errors: Record<string, string>;
    processing?: boolean;
}

export default function PengawasanIinNasionalForm({ data, setData, errors, processing }: PengawasanIinNasionalFormProps) {
    return (
        <motion.div
        ...
        >
            <div className="space-y-6">
                <div className="flex items-center gap-3 border-b border-gray-200 pb-4">
                    ...
                    <h2 className="text-xl font-semibold text-gray-900">Formulir Pengawasan IIN Nasional</h2>
                </div>
